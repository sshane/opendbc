...
struct CarState {
  ...
  gearActual @62 :UInt8;   # actual gear number for manual cars (1-6, 0 for neutral/unknown)
  inNeutral @63 :Bool;     # neutral gear signal from car
  shiftSmoothness @64 :Float32;  # smoothness of last shift (accel std dev, lower=smoother), 0 when no shift
  shiftGrade @65 :UInt8;   # grade of last shift: 0=none, 1=good, 2=ok, 3=poor
  isLugging @66 :Bool;     # true when engine is lugging (low RPM under load)
